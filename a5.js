...
let p1 = null, t1 = 0, marker, frame;

function reset() {
  p1 = null; marker?.remove(); frame?.remove();
}
...
document.addEventListener('click', async e => {
  ...
  frame = Object.assign(document.createElement('div'), {
    style: `
      position:fixed;left:${x1}px;top:${y1}px;width:${w}px;height:${h}px;
      border:2px dashed #ff1744;pointer-events:none;z-index:${Z}
    `
  });
  ...
  try {
    ...
    const img = Object.assign(new Image(), {
      ...
      style: `
        ...
        border:2px solid #00e676;box-shadow:0 0 10px #000;z-index:${Z}
      `
    });
